			...
			if( $('#flotTip').length > 0 ){
				...
				if(to.defaultTheme) {
					$tip.css({
						'background': '#fff',
						'z-index': '100',
						'padding': 'http://mosaicpro.biz/adminplus/php/theme/scripts/flot/0.4em 0.6em',
						'border-radius': 'http://mosaicpro.biz/adminplus/php/theme/scripts/flot/0.5em',
						'font-size': 'http://mosaicpro.biz/adminplus/php/theme/scripts/flot/0.8em',
